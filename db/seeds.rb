...
prop26 = Proposition.create(trip_id:trip2.id, user_id: user3.id, category: "food", start_date: Date.new(2021,9,16), end_date: Date.new(2021,9,16), due_date: "2021-06-15", title: "Brunch Cruise Odyssey", description: "brunch sur un boat oklm", url: "https://www.getyourguide.com/washington-dc-l62/washington-dcgourmet-brunch-or-dinner-cruise-on-the-odyssey-t279712/", address: "Washington Avenue Southwest, Washington, District of Columbia, United States of America", status: "validated")
